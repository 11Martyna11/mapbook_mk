...
ramka_lista_obiektow.grld(row=0, column=0)
ramka_formularz.grld(row=0, column=1)
ramka_szczegoly_obiektow.grld(row=1, column=0, columnspan=2)
ramka_mapa.grld(row=2, column=0)
...
listbox_lista_obiektow.grid(row=1, column=0, columnspam=3)
...
label_miejscowosc_=Label(ramka_formularz, text='Miejscowość:')
label_miejscowosc_.grid(row=3, column=0)
...
label_pokaz_szczegoly_surname=Label(ramka_szczegoly_obiektow, text='Szczegoly użytkownika:')
label_pokaz_szczegoly_surname.grid(row=0, column=0)

label_szczegoly_obiektu_name_wartosc=Lbel(ramka_szczegoly_obiektow, text='....')
